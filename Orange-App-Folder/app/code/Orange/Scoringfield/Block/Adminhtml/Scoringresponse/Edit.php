...
class Edit extends \Magento\Backend\Block\Widget\Form\Container {
    ...
    protected function _construct() {
        ...
        $this->buttonList->update('delete', 'label', __('Delete Content'));
    ...
    public function getHeaderText() {
        if ($this->_coreRegistry->registry('scoringfield_scoringresponse')->getId()) {
            return __("Edit Item '%1'", $this->escapeHtml($this->_coreRegistry->registry('scoringfield_scoringresponse')->getId()));
        } else {
            return __('New Item');
        }
    }
