 ...
 */
abstract class AbstractGlobalPay extends AppAction implements RedirectLoginInterface
{
    /**
     * @var \Dilmah\Payments\Model\GlobalPay\Checkout
     */
    protected $_checkout;
     ...
     * @var string
     */
    protected $_checkoutType = 'Dilmah\Payments\Model\GlobalPay\Checkout';
    ...
    protected function _initCheckout()
    {
        ...
        if (!$quote->hasItems() || $quote->getHasError()) {
            ...
            throw new \Magento\Framework\Exception\LocalizedException(__('We can\'t start Global Payments Checkout.'));
        }
    ...
    /**
     * save payment info when returning from blobalpay
     *
     * @return void
     */
    public function saveHistoryReturnInfo()
    {
        ...
        $data['status'] = $this->_txnResponseCode;
        ...
        if (!$lastPaymentHistoryId) {
            /*
             * if for some reason the last payment history id is not available, we need to fill the other fields as well
             * to recognize the order since it will be saved as a new record.
             */
        ...
        try {
            ...
            $this->logger->error('SAVE PAYMENT HISTORY - FROM GLOBALPAY: ' . $e->getMessage());
