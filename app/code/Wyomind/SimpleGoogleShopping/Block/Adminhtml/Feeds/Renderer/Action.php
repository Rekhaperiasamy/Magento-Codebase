...
class Action extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Action
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $actions = [
            ...
            [// Generate
                'caption' => __('Generate'),
                'url' => "javascript:Index.feeds.generate('" . $this->getUrl('simplegoogleshopping/feeds/generate', ['id' => $row->getId()]) . "');"
            ],
            [// Preview
            ...
            [// Delete
                'caption' => __('Delete'),
                'url' => "javascript:Index.feeds.delete('" . $this->getUrl('simplegoogleshopping/feeds/delete', ['id' => $row->getId()]) . "');"
            ]
        ];
