<?php
namespace Orange\PromoDescription\Block\Adminhtml\PromotionDescription;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
		...
		\Orange\PromoDescription\Model\ResourceModel\PromotionDescription\Collection $collectionFactory,
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            array(
                'label' => __('Delete'),
                'url' => $this->getUrl('promodescription/*/massDelete'),
    ...
    {
        return $this->getUrl('promodescription/*/index', ['_current' => true]);
    }
