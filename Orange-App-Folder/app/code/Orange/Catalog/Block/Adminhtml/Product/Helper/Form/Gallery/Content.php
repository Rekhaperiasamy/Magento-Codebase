 ...
 */
namespace Orange\Catalog\Block\Adminhtml\Product\Helper\Form\Gallery;
        ...
        if (is_array($value) &&
            ...
            foreach ($images as &$image) {
                ...
                try {
                    ...
                    $image['size'] = 0;
					/** 
					 *	FIX for Cannot gather stats! Warning!stat(): stat failed in admin product edit section
					 *	Temporary fix by TechM since magento core team hasn't fixed yet
					 **/
