...
namespace Dilmah\Orderstatus\Controller\Adminhtml\Order;

use Dilmah\Orderstatus\Model\Order\Order;
...
class Editstatus extends AbstractMassAction
{
     ...
     * {@inheritdoc}
     */
    const ADMIN_RESOURCE = 'Dilmah_Orderstatus::dilmahorderstatus_change_status';
