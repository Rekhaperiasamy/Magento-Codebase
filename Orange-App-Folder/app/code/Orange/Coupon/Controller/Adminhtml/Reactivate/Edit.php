...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Orange_Coupon::activate')
            ->addBreadcrumb(__('Coupon'), __('Coupon'))
            ->addBreadcrumb(__('Reactivate'), __('Reactivate'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('coupon_data', NULL);

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->getConfig()->getTitle()->prepend(__('Reactivate Coupon'));
        return $resultPage;
    }
}