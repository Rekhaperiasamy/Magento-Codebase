...
class Index extends Action
{
    ...
    public function execute()
    {
		...
		$filepath = 'Abandoned_Order_Report' . date('Ymd').'.csv';
		$outputFile = BP.'/pub/media/'.$filepath;
        ...
        foreach ($items as $order) {
			...
			if($scoreData) {
				...
				if(isset($scoringDeclineReason['scoringReason'])) {
					/**
                    * @Defect 5610
                    * scoring_decline_reason should display both the code and the content of the decline reason
                    * @Solution - Include error code in scoring decline reason
                    * @Author - Mohan YM
                    * @Date - 23/11/2017
                    */
  					$scoringDeclineReasonValue = $scoringDeclineReason['errorCode']."::".$scoringDeclineReason['scoringReason'];
				}
        ...
        //$this->downloadCsv($mediadirectory);
