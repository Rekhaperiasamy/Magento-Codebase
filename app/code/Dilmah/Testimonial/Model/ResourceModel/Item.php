...
namespace Dilmah\Testimonial\Model\ResourceModel;
...
class Item extends AbstractDb
{
    ...
    {
        $this->_init('dilmah_testimonial', 'item_id');
    }
    ...
    public function lookupStoreIds($itemId)
    {
        ...
        $select = $connection->select()->from(
            $this->getTable('dilmah_testimonial_store'),
            'store_id'
        )->where(
            'item_id = ?',
            (int) $itemId
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $table = $this->getTable('dilmah_testimonial_store');
