...
class Status extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
		...
		\Orange\Catalogversion\Model\ResourceModel\Catalogdraft\Collection $collectionFactory,
    ...
    protected function _prepareCollection()
    {
	  ...
	  //echo get_class($this->_collectionFactory);
		try{
  	...
  	$this->addColumn(
		...
		$this->addColumn(
            ...
            [
                ...
                'index' => 'status',
                'class' => 'status',
				'renderer'  => '\Orange\Catalogversion\Block\Adminhtml\Draft\Renderer\Status',
            ]
        );
