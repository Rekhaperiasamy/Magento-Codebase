...
(function (factory) {
    ...
    var rules = {
        ...
        "validate-password": [
            ...
            $.mage.__('Please enter 8 or more characters. Leading and trailing spaces will be ignored.')
        ],
        ...
        "validate-customer-password": [
            function (v, elm) {
                ...
                if (result == false) {
                    validator.passwordErrorMessage = $.mage.__("Minimum length of this field must be equal or greater than %1 symbols.").replace('%1', passwordMinLength) + " " +
                        $.mage.__("Leading and trailing spaces will be ignored.");
                    return result;
                }
                if (pass.match(/\d+/)) {
                    counter ++;
                ...
                if (counter < passwordMinCharacterSets) {
                    result = false;
                    validator.passwordErrorMessage = $.mage.__("Minimum of different classes of characters in password is %1.").replace('%1', passwordMinCharacterSets) + " " +
                        $.mage.__("Classes of characters: Lower Case, Upper Case, Digits, Special Characters.");
                }
                return result;
            }, function () {
