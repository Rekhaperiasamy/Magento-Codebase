<?php
namespace Orange\Errormessage\Block\Adminhtml\Errormessage;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
		...
		\Orange\Errormessage\Model\ResourceModel\Errormessage\Collection $collectionFactory,
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            array(
                'label' => __('Delete'),
                'url' => $this->getUrl('errormessage/*/massDelete'),
    ...
    {
        return $this->getUrl('errormessage/*/index', ['_current' => true]);
    }
