...
class Save extends \Magento\Backend\App\Action
{
	...
	public function execute()
    {
        ...
        if ($data) {
            $model = $this->_objectManager->create('Orange\Errormessage\Model\Errormessage');
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('Error has been Saved'));
			 ...
			 exit;
                $this->messageManager->addException($e, __('Something went wrong while saving the Error.'));
            }
